...
def crop_to_hint(path):
    ...
    if vects is False:
        print('Invalid image, renaming file to end with _INVALID, but you never reach this')
        oldfilepath = path
        newfilepath = oldfilepath.replace("_ADDED.jpg", "_INVALID.jpg")
...
def draw_hint(path):
    ...
    im3.save('C:/Users/Azhar/Documents/Programming/katClick/KatClick/data/' + filename, 'JPEG')
